...
- name: "trojan-美国"
  type: trojan
  server: www.torainya.shop
  port: 443
  password: 9gLZtQASsfioLfzs
  # udp: true
...
- name: "trojan-首尔"
  type: trojan
  server: usuck.torainya.shop
  port: 443
  password: SeIJKIGEtR9NOVj9
  # udp: true
  # sni: example.com # 填写伪装域名
  alpn:
     - h2
...
- name: "trojan-日本"
  type: trojan
  server: fucku.torainya.shop
  port: 443
  password: P5WPgQRz7G6touxI
  # udp: true
  # sni: example.com # 填写伪装域名
  alpn:
     - h2
